...
<div className="block translation" data-element="para" data-attr-xinfo-text="10926">For example:</div>
<div className="block translation" data-element="para" data-attr-xinfo-text="10926">When you begin testing, you’ll not yet have a system in place for calling the Companion Card Local API. You can, therefore, use this tool to post requests to the API directly — like when creating your first test card.</div>
