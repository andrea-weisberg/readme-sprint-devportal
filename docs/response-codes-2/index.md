...
<h2>Important</h2>
<p>Any argument that has the type <span className="xml-highlight">date</span> needs to follow the XML-RPC specified ISO 8601 date-time format: <dateTime.iso8601>YYYYMMDDTHH:mm:ss<dateTime.iso8601></p>
...
<li>Keys do not need to be in any particular order or sequence within <span className="xml-highlight">transactionData</span></li>
<li>Customers must be able to receive all keys available within <span className="xml-highlight">transactionData</span></li>
