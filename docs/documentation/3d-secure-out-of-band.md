...
---
<!-- MIGRATION_METADATA
Migrated-From: https://developer.sprint.paymentology.com/3d-secure-out-of-band/
Source-Slug: 3d-secure-out-of-band
Migrated-On: 2026-02-12T21:13:16+00:00
...
MessageType: [3DSecureAppAuthentication](../companion-api/api-reference-companion/remote/administrativemessage/#3DSAppAuth)

**

- If the client is a Card API client, Paymentology sends a RemoteMessaging message to the client

MessageType: [3DSecure.AppAuthentication](../card-api/api-reference-card/remotemessaging#appauth) **
...
- Companion API client’s use this [ThreeDSAuthenticationOutcome](../companion-api/api-reference-companion/local-api/threedsauthenticationoutcome-1) API.

- Card API client’s use this [ThreeDSAuthenticationOutcome](../card-api/api-reference-card/threedsauthenticationoutcome) API.
...
MessageType: [3DSecureAppFinalisation](../companion-api/api-reference-companion/remote/administrativemessage/#3DSAppFinal) **

-

Card API clients receive a RemoteMessaging message from Paymentology.

MessageType: [3DSecure.AppFinalisation **](../card-api/api-reference-card/remotemessaging#appfinal)
