...
---
<!-- MIGRATION_METADATA
Migrated-From: https://developer.sprint.paymentology.com/reporting-api-2/
Source-Slug: reporting-api-2
Migrated-On: 2026-02-12T20:29:48+00:00
...
```
GET/v1/clients/{clientuuid}/campaigns/{campaignuuid}/reports
```
...
```
GET/v1/clients/{clientuuid}/campaigns/{campaignuuid}/reports/{reportId}
```
...
```
GET/v1/clients/{clientuuid}/campaigns/{campaignuuid}/reports/{reportId}/{Date}
```
