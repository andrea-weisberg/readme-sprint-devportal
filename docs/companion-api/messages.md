...
<p>These messages are <strong style={{fontSize: "16px"}}>sent to notify you if Paymentology stopped the companion card.</strong><span style={{fontSize: "16px"}}> For example, if a validation process has failed to pass, Paymentology would stop the card for security reasons and send a notification to that effect. This requires making a call to the </span><a href="https:developer.sprint.paymentology.com/companion-api/api-reference/local-api/stopcard/"><span className="xml-highlight">StopCard</span></a><span style={{fontSize: "16px"}}> method.</span></p>
</span></span></a></span></strong></p></h2></p></p></p></a></li></a></li></a></li></ul></h3></p></strong></p></h2></p></strong></p>
