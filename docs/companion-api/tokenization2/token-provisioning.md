...
1. [**Digitization.activationmethods**](https://developer.sprint.paymentology.com/administrative-message-values/#activationmethods)
...
2. [**Digitization.activation**](https://developer.sprint.paymentology.com/administrative-message-values/#activation)
...
3. [**Digitization.complete**](https://developer.sprint.paymentology.com/administrative-message-values/#complete)
...
4. [**Digitization.exception**](https://developer.sprint.paymentology.com/administrative-message-values/#exception)
