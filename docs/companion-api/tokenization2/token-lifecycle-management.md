...
<Image border={false} src="https://files.readme.io/d20b5a294095e35dfe54d37d80ae3862cd7dc2d4bd09d71fd7f6f6022a3788f7-image.png" />
...
1. [**Digitization.event.stopped**](https://developer.sprint.paymentology.com/administrative-message-values/#stopped)
...
2. [**Digitization.event.digitized**](https://developer.sprint.paymentology.com/administrative-message-values/#digitized)
...
3. [**Digitization.event.Deleted_from_device**](https://developer.sprint.paymentology.com/administrative-message-values/#deletedfromdevice)
...
4. [**Digitization.event.Deleted**](https://developer.sprint.paymentology.com/administrative-message-values/#eventdeleted)

This is when Paymentology informs the wallet that a token has been removed in its entirety.

5. [**Digitization.event.Replacement**](https://developer.sprint.paymentology.com/administrative-message-values/#replacement)
