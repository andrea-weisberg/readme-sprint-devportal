...
<li style={{fontWeight: "400"}} aria-level="1"><span style={{fontWeight: "400"}}>It drives payment innovation on the Sprint platform, such as the adoption of digital wallet technology—like Apple Pay and Android Pay. These wallets store digital versions of payment cards, avoiding the need to carry physical cards. </span></li>
