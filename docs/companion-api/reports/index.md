...
>
  You can generate all reports below by sending an HTTP GET request and
  downloading the report as a CSV file. These downloadable reports are
  <strong> only available for 60 days</strong>.
</div>
