...
<p><a className="btn btn--secondary" href="testing.md" style={{display: 'inline-block', padding: '18px 28px', background: '#0B1B33', color: '#fff', textDecoration: 'none', borderRadius: '10px', fontWeight: '700', letterSpacing: '0.5px'}}>EXPLORE OUR TESTING ENVIRONMENTS</a></p>
