...
<p>You’ll need to make a call to the <span class="xml-highlight">LoadFunds</span> method.</p>
...
<p>You’ll need to make a call to the <span class="xml-highlight">LoadFundsReverse</span> method.</p>
...
<p>You’ll need to make a call to the <span class="xml-highlight">TransferFunds</span> method.</p>
...
<p>You’ll need to make a call to the​ <span class="xml-highlight">TransferFundsReverse</span> method.</p>
...
<p>You’ll need to make a call to the​ <span class="xml-highlight">PocketTransfer</span> method.</p>
...
<p>You’ll need to make a call to the​ <span class="xml-highlight">PocketTransferReverse</span> method.</p>
...
<p>You’ll need to make a call to the <span class="xml-highlight">DeductFunds</span> method.</p>

<h2 class="block highlight" data-element="bridgehead" data-attr-renderas="sect3" data-attr-xml-id="bridgehead-idm4646117335828831693994440263"><span class="inline translation current" data-element="emphasis" data-attr-role="bold" data-attr-xinfo-text="10463">8. Reversing the card deduction​</span>​</h2>
<p class="placeholder">​If you want to reverse the funds deducted, for any reason, then you can initiate a reversal process. ​Once successful, the balance will change based on the reversed amount.</p>
<p class="placeholder"><span class="inline link linktool link-external" data-element="link" data-attr-xlink-href="https://developer.sprint.paymentology.com/card/documentation/card-api#deductfundsreverse">You’ll need to make a call to the ​<span class="xml-highlight">DeductFundsReverse</span> method.</span></p>
...
<p>You’ll need to make a call to the <span class="xml-highlight">​Devalue</span> method.</p>
