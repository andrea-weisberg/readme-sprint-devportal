...
- **Issuer POS Decline Rate (%)** – this is the percentage decline rate for the given month for Apple Pay POS transactions. The calculation is _Apple Pay Declined POS Transactions_ / _Apple Pay Total POS Transactions_ = **_Issuer POS Decline Rate._**
...
- **Issuer Remote Decline Rate (%)** – this is the percentage decline rate for the given month for Apple Pay remote transactions. The calculation is _Apple Pay Declined Remote Transactions_ / _Apple Pay Total Remote Transactions_ = **_Issuer Remote Decline Rate._**
