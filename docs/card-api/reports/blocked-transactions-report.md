...
The report includes details about vouchers and reasons for transactions being filtered. This report helps clients identify if any whitelisted merchants (approved merchants) are blocked.
...
* **Type** – filtered transaction type (string):
  * POS
  * ATM
* **Date Blocked** – date the transaction was blocked (YYYY/MM/DD HH:MM:SS).
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="center">
        \[CampaignName] Blocked Transactions –
        \[dateBegin:yymmdd] – \[dateEnd:yymmdd].xls
      </td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="center">
        This report is generated weekly, only on Thursday.
      </td>
    </tr>
  </tbody>
</table>
