...
<p><span style={{fontWeight: "400"}}>The Mark-off file has the following fields:</span></p>
</div>
<ul>
<li><strong>Campaign name </strong>– the name of the client’s campaign</li>
<li><strong>Paymentology System Date</strong> – <span style={{fontWeight: "400"}}>Paymentology’s system date in UTC+7 time zone</span></li>
