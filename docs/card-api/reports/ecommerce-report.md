...
- **DeclineReason** – describes why the transaction was declined. If the transaction was successful then this field is left blank.
...
- **Recurring** – specifies whether the transaction is a once-off or recurring through COF method.
