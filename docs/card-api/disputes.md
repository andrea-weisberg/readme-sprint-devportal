...
---
<!-- MIGRATION_METADATA
Migrated-From: https://developer.sprint.paymentology.com/card-api/disputes/
Source-Slug: disputes
Migrated-On: 2026-02-12T20:43:39+00:00
...
| REASON CODE | REASON CODE DESCRIPTION | TIMEFRAME |
| --- | --- | --- |
| 4808 | Authorization-related Chargeback | 90 calendar days |
| 4853 | Cardholder dispute | 120 calendar days |
| 4837/4849/4870/4871 | Fraud<br><br>- No cardholder authorization<br><br>- Questionable merchant activity<br><br>- Chip liability shift<br><br>- Chip liability shift - Lost/Stolen/ Never Received Issue (NRI) fraud | 120 calendar days |
| 4834 | Point-of-interaction error | 90 calendar days but for ATM related disputes - 120 calendar days apply |


[Dispute Resolution Form – Fraud](../../assets/Dispute-Resolution-Form-Fraud.docx)

[Dispute Resolution Form](../../assets/Dispute-Resolution-Form.docx)
...
| --- | --- | --- | --- |
| EMV Liability Shift Non-Counterfeit Fraud | Visa Fraud Monitoring Program | Late Presentment | Merchandise/Services not received |
| EMV Liability Shift Non-Counterfeit Fraud | Declined Authorization | Incorrect Transaction Code | Cancelled Recurring |
| EMV Liability Shift Non-Counterfeit Fraud | No Authorization | Incorrect Currency | Not as Described or Defective Merchandise/Services |
| EMV Liability Shift Non-Counterfeit Fraud |  | Incorrect Account Number | Counterfeit Merchandise |
| Visa Fraud Monitoring Program |  | Incorrect Amount | Misrepresentation |
|  |  | Duplicate Processing/Paid by Other Means | Credit Not Processed |
|  |  | Invalid Data | Cancelled Merchandise/Services |
|  |  |  | Original Transaction Not Accepted |
|  |  |  | Non-Receipt of Cash or Load Transaction Value |


[Visa Generic Dispute Form](../../assets/Visa-Generic-Dispute-Form.docx)
...
If a transaction was processed with [3D Secure](../companion-api/manage-funds/3d-secure), we are not able to submit a Fraud chargeback therefore, the first step is to establish if there was a 3D Secure validation done.
