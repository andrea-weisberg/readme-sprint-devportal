...
- [Statement](https://developer.sprint.paymentology.com/card-api/api-reference/statement/) – Retrieve the statement of a card (or pocket if applicable). _NB. Version 1.3 available_
