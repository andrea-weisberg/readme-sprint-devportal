...
<li>Paymentology receives the API request and converts PIN block Format 1 to clear text PIN.</li>
<li>Paymentology saves the details in the backend.</li>
<li>Paymentology re-encrypts the clear text PIN into PIN block Format 0, this is then used in the PAN file sent to the Card Manufacturer.</li>
...
<h4><a id="pinencryption"></a>pinBlock PIN encryption</h4>
