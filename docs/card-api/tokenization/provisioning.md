...
<Image border={false} src="https://files.readme.io/4ad218ab90ca08c5dbd7a6948147a9966155d7d5264f709abe0bdd6b37a836d6-image.png" />
...
<table>
  <thead>
    <tr>
      <th align="center">PUSH PROVISIONING</th>
      <th align="center">MANUAL PROVISIONING</th>
    </tr>
  </thead>

  <tbody>
    <tr>
      <td align="center">OTP verification not required</td>

      <td align="center">
        OTP verification required.<br />
        However, some wallets (e.g. Samsung Pay) do not require OTP verification.
      </td>
    </tr>

    <tr>
      <td align="center">TAV certification required</td>
      <td align="center">TAV certification not required</td>
    </tr>
  </tbody>
</table>
