...
| scheduledStopDetails | String | The details of the existing schedules including those that have been cancelled or processed in (XML escaped) JSON format. See example below. |
...
**scheduledStopDetails example (XML escaped JSON format):**
