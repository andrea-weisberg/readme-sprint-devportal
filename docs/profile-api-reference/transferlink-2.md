...
<!-- MIGRATION_METADATA
Migrated-From: 
Source-Slug: transferlink-2
Migrated-On: 2026-02-12T20:54:52+00:00
...
| oldCardIdentifier | String | 1-20 characters | ✓ | The card number, sequence number or tracking number of the card being transferred FROM. |
| newCardIdentifier | String | 1-20 characters | ✓ | The card number, sequence number or tracking number of the card being transferred TO. This parameter can’t be empty for this call. |
...
| --- | --- | --- |
| resultCode | String | Status code indicating transaction result. |
