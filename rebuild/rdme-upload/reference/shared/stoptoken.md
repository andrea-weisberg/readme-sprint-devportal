...
Stop reason associated with the reason for stopping the token. The reason ID for stopping the token are the same as DeleteToken.

Description as to why the token was stopped
