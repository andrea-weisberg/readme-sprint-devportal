...
Usually the same reason used for stopping the token. The reason ID for stopping the token are the same as [DeleteToken](/api-reference/profile-api-reference/deletetoken).
