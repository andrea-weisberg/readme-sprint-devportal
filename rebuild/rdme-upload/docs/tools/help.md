...
- Upload your logo in either.png or.jpg format.

- Select the card scheme – either Mastercard or Visa – in the dropdown box

- Enter the title of your message in the “Title” box – default is “Payment confirmation”.

- Enter the text for your message in the “Main text” box.

- In the event that the OTP entered is incorrectly, enter the text for the error message in the “Wrong OTP Error Message” box.
...
- Enter the title of your message in the “Title” box – default is “Authentication”.
...
- Enter the text to direct the cardholder towards your support channels and provide contact details.

## How to submit your file

As you enter all the information, the screen on the right updates so that you have a real-time view of what the screen will look like. Once you are happy with the screens:

- Download the file. It downloads as a zip file with the individual files that are required in the correct formats.

- Email this zip file to support@paymentology.com marked for the attention of your Paymentology representative. You will receive a ticket number which you can use to follow up with your Paymentology representative on the progress of your request.
