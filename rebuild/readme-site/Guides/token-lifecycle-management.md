...
The token lifecycle events are managed through the AdministrativeMessage method. The messageName path parameter, required in the AdministrativeMessage method, specifies the name of the administrative messages sent to the client.![Token lofecycle management flow](https://developer.sprint.paymentology.com/wp-content/uploads/2023/03/Token-life-cycle-management-v2.png)
