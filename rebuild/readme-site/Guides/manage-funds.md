...
You’ll need to respond with Approved for the transaction to be concluded successfully.![Companion API transaction processing](https://developer.sprint.paymentology.com/wp-content/uploads/2023/03/Companion-transaction-processing-3-v2.png)
...
Here is a table that shows the only acceptable response codes that can be sent to Paymentology:![Reversal flow](https://developer.sprint.paymentology.com/wp-content/uploads/2023/03/Reversal-v2.png)
