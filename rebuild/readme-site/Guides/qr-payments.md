...
- checksum![](https://developer.sprint.paymentology.com/wp-content/uploads/2023/03/QR-Payments-receive-bank-v2.png)
...
To create the QR code, you’ll use the Mastercard QR generator. You should ensure that the correct data is imported into the generator.![End to end - how QR payments work](https://developer.sprint.paymentology.com/wp-content/uploads/2023/03/QR-Payments-End-to-end-v2.png)
...
The [SimPOS tool](/tools/simpos) can be used to facilitate a load to a merchant or a card, as well as an OI load.![](https://developer.sprint.paymentology.com/wp-content/uploads/2023/03/QR-Payments-Merchant-onboarding-v2.png)
