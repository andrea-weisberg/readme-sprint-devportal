...
- Go to [SimPOS](/tools/simpos) under [Tools](/tools/tools)

- Click on the "**Web**" tab

- Enter the card number, expiry date and CVV for the test card that was created using CreateLinkedCard method on the **local API**

- Enter a random amount for the test transaction

- Enter a random merchant

- Click on "**Swipe**" button

- Wait for "**Transaction result pop-up**" which will show various response codes. Refer to the full list of response codes on the API documentation page.

You can find a list if SimPOS Response codes [here](/tools/simpossimpos-result-codes/).
